...
<head>
   ...
   {{-- ajax --}}
   <script src="https://cdnjs.cloudflare.com/ajax/libs/smooth-scrollbar/8.8.1/smooth-scrollbar.min.js" integrity="sha512-DmxN+h4rvEbHxmkzhxEA1krRvgdzSFhjkcTe2HCZpd5ZnxP9+OWGHB8iMUQhvidmrivCTe3g0hyeMpfTLIwf7Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
.btn-gen{color:#fff; background:var(--main); transition:all 0.3s ease }
.btn-gen:hover{color:#fff; background:rgba(81,81,81,0.95) }
.btn-gen:active{color:#fff; background:var(--third); }
...
background-color: rgba(207, 204, 204, 0.1);color: red; 
}
...
.navbar{  padding: 0 20px ;box-shadow: 0 1px 26px 0 rgb(0 0 0 / 20%), 0 1px 20px 0 rgb(0 0 0 / 5%);
}
 
 ul li {
      padding-left: 0 !important;  
     padding-right: 0 !important;  display:inline;
}

.avatarBar{width:35px; border-radius:50%;  object-fit: cover;height:35px;}
.brandRLogo{height:35px;margin:0 0.25em}
.brandRLogoCompany{height:35px;margin:0 0.25em;  }
		
.userNameAvatar{  align-items: center;} 
.userNameAvatar span{font-size:1.1em; font-weight:bold; margin:0 0.30em; color:rgba(81,81,81,0.95);} 

.navbar div ul{margin:0 15px 0 0 ; padding:0}

.noDecor{text-decoration:none}
 .appfooter{width:100%;padding:10px;background:var(--main); text-align:right;color:#fff;font-weight: 400;}
...
height:100%	}
	...
	.menu .menu-items li{ transition:all 0.3s ease}
	.menu ul li{display: block; margin:15px 0px 0 0; transition:all 0.3s ease}
	.menu ul li a {text-decoration:none ; font-size:1.15em ; font-weight:450 ;color: #fff; transition:all 0.3s ease}
	.menu ul {margin:50px 10px 0 0; padding:0}
...
<body class="bg-light"id="my-scrollbar">
    ...
    <div class="menu">  
        <ul class="menu-items">
                <li><a href="#home"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> Home</a></li>
                <li><a href="#about"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> About</a></li>
                <li><a href="#food"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> Category</a></li>
                <li><a href="#food-menu"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> Menu</a></li>
                <li><a href="#testimonials"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> Testimonial</a></li>
                <li><a href="#contact"><i class="fas fa-spinner " style="font-size:1.5em ; color:#fff; vertical-align:middle;" ></i> Contact</a></li> 
            </ul></div>
    ...
    <div class="text-right"  >
        ...
        <li id="lateaction" class="nav-item dropdown1">
            <i class="fas fa-spinner fa-spin" style="font-size:1.5em ; color:var(--main); vertical-align: -webkit-baseline-middle;" ></i>
        </li> 
	...
	<div class="d-flex ml-auto">
        ...
        <span class="navbar-brand ">    <img src="{{asset('admin_assets/images/mktabeeLogo.svg')}}" alt="mktabeeLogo" class="brandRLogo "/>  <img src="mktabeeLogo.svg " class="brandRLogoCompany  "/> </span>
         
    </div>	
    
		<h3>hello in navbar</h3>
